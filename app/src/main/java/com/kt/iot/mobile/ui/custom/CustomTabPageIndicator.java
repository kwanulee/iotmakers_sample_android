...
public class CustomTabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    private void addTab(int index, CharSequence text, int iconResId) {
        ...
        if(index == 0){
            tabView = new TabView(getContext(), R.attr.vpiTabPageIndicatorStyleLeft);
        }else if(index == 2){
            tabView = new TabView(getContext(), R.attr.vpiTabPageIndicatorStyleRight);
        }else {
